...
#+END_SRC
** Step by step
1. Download the script using =wget= (or from the [[https://github.com/AfzGit/pegasus-skyscraper/releases/tag/Latest][Releases]] page)
#+BEGIN_SRC bash
...
3. Move it in one of your =$PATH= folder for easy access (like =/usr/bin=)
#+BEGIN_SRC bash
